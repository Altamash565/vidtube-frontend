...
export const PrivacyPolicy: React.FC<PrivacyPolicyProps> = ({
  ...
  const logoSvg = (
    <svg style={{ width: '100%' }} viewBox="0 0 63 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <linearGradient id="paint0_linear_53_10115_pp" x1="2.23416" y1="20.3361" x2="26.863" y2="44.9649" gradientUnits="userSpaceOnUse">
    ...
    <div className="h-screen overflow-y-auto bg-[#121212] text-white flex flex-col text-left select-none">
      ...
      <section className="relative mx-auto max-w-3xl px-4 py-20">
        <div className="mb-16 text-center">
          <h1 className="mb-3 text-sm font-semibold tracking-wider uppercase text-[#ae7aff]">Privacy Policy</h1>
          <h2 className="mb-4 text-4xl font-bold text-white">We care about your privacy</h2>
          <h3 className="text-gray-300 text-lg leading-relaxed">
            Your privacy is important to us at videoTube. We respect your privacy regarding any information we may collect from you across our website.
          </h3>
        </div>
        ...
        <div className="mb-8">
          <h3 className="mb-4 text-xl font-bold sm:text-2xl md:text-3xl text-white">How long do we keep your information?</h3>
          <p className="mb-4 text-gray-300 leading-relaxed">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum fuga asperiores voluptatibus quidem dolores, quos officiis nostrum veritatis. A praesentium dicta temporibus vitae, excepturi sequi itaque? Pariatur veniam praesentium error qui necessitatibus. Et autem dolorum consectetur officia, provident quasi soluta?
          </p>
        </div>
